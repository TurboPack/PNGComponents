...
// (DO NOT EDIT: machine generated header) 'PngComponentsDDesign.dpk' rev: 29.00 (Windows)

#ifndef PngcomponentsddesignHPP
#define PngcomponentsddesignHPP
...
#include <SysInit.hpp>
#include <PngComponentsRegister.hpp>
#include <PngComponentEditors.hpp>
#include <PngImageListEditor.hpp>
...
#include <PngImageList.hpp>	// (PngComponentsD)
#include <PngFunctions.hpp>	// (PngComponentsD)
#include <PngBitBtn.hpp>	// (PngComponentsD)
...
namespace Pngcomponentsddesign
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Pngcomponentsddesign */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_PNGCOMPONENTSDDESIGN)
using namespace Pngcomponentsddesign;
#endif
#pragma pack(pop)
#pragma option pop
