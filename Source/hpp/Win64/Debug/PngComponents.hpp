...
// (DO NOT EDIT: machine generated header) 'PngComponents.dpk' rev: 29.00 (Windows)

#ifndef PngcomponentsHPP
#define PngcomponentsHPP
...
#include <PngButtonFunctions.hpp>
...
namespace Pngcomponents
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Pngcomponents */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_PNGCOMPONENTS)
using namespace Pngcomponents;
#endif
#pragma pack(pop)
#pragma option pop
