...
var
  PngImageListEditorDlg: TCustomPngImageListEditorDlg;
...
{ TCustomPngImageListEditorDlg }

function TCustomPngImageListEditorDlg.ConformDimensions(Png: TPngImage): Boolean;
begin
...
function TCustomPngImageListEditorDlg.FirstSelected: Integer;
begin
...
function TCustomPngImageListEditorDlg.LastSelected: Integer;
begin
...
procedure TCustomPngImageListEditorDlg.DrawBackground(Canvas: TCanvas; const ARect: TRect;
...
procedure TCustomPngImageListEditorDlg.GetColorProc(const S: string);
begin
...
procedure TCustomPngImageListEditorDlg.ParseBackgroundColor(Sender: TObject; CanDisplayError, CanChangeText: Boolean);
var
  S: string;
...
procedure TCustomPngImageListEditorDlg.SelectBackgroundColor(Sender: TObject; Color: TColor);
var
  S: string;
begin
...
procedure TCustomPngImageListEditorDlg.btnAddClick(Sender: TObject);
var
...
procedure TCustomPngImageListEditorDlg.btnClearClick(Sender: TObject);
begin
...
procedure TCustomPngImageListEditorDlg.btnDeleteClick(Sender: TObject);
...
procedure TCustomPngImageListEditorDlg.btnDownClick(Sender: TObject);
var
  I: Integer;
begin
...
procedure TCustomPngImageListEditorDlg.btnReplaceClick(Sender: TObject);
var
...
procedure TCustomPngImageListEditorDlg.btnUpClick(Sender: TObject);
var
  I: Integer;
begin
...
procedure TCustomPngImageListEditorDlg.cmbBackgroundColorChange(Sender: TObject);
begin
  //While typing, try parsing the background color, but without any error messages
  ParseBackgroundColor(Sender, False, False);
end;

procedure TCustomPngImageListEditorDlg.cmbBackgroundColorDblClick(Sender: TObject);
begin
...
procedure TCustomPngImageListEditorDlg.cmbBackgroundColorExit(Sender: TObject);
begin
...
procedure TCustomPngImageListEditorDlg.cmbPreviewBackgroundChange(Sender: TObject);
begin
  //Pewview background is changes, repaint all items
  lbxImages.Repaint;
end;

procedure TCustomPngImageListEditorDlg.cmbPreviewBackgroundDrawItem(Control: TWinControl;
...
function TCustomPngImageListEditorDlg.ConformAdjustDimensions(Png: TPngImage; const AFileName: string): Boolean;
begin
...
procedure TCustomPngImageListEditorDlg.edtNameChange(Sender: TObject);
begin
...
procedure TCustomPngImageListEditorDlg.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TCustomPngImageListEditorDlg.FormCreate(Sender: TObject);
var
  Space8H: Integer;
begin
...
procedure TCustomPngImageListEditorDlg.FormResize(Sender: TObject);
begin
...
procedure TCustomPngImageListEditorDlg.FormShow(Sender: TObject);
var
  I: Integer;
begin
...
procedure TCustomPngImageListEditorDlg.lbxImagesClick(Sender: TObject);
...
procedure TCustomPngImageListEditorDlg.lbxImagesDblClick(Sender: TObject);
begin
...
procedure TCustomPngImageListEditorDlg.lbxImagesDragOver(Sender, Source: TObject;
...
procedure TCustomPngImageListEditorDlg.lbxImagesDrawItem(Control: TWinControl; Index: Integer; ARect: TRect; State: TOwnerDrawState);
var
  DrawRect: TRect;
...
procedure TCustomPngImageListEditorDlg.lbxImagesEnter(Sender: TObject);
begin
  //Just to be sure
  lbxImages.Repaint;
end;

procedure TCustomPngImageListEditorDlg.lbxImagesExit(Sender: TObject);
begin
  //Just to be sure
  lbxImages.Repaint;
end;

procedure TCustomPngImageListEditorDlg.lbxImagesKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TCustomPngImageListEditorDlg.lbxImagesMeasureItem(Control: TWinControl; Index: Integer; var Height: Integer);
var
  Temp: Integer;
begin
...
procedure TCustomPngImageListEditorDlg.lbxImagesMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TCustomPngImageListEditorDlg.lbxImagesStartDrag(Sender: TObject; var DragObject: TDragObject);
var
  Pos: TPoint;
begin
